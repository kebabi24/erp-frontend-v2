...
export class UsersService {
  ...
  public updateProfile(data, id) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.put(API_URL_PROFILE + '/' + id, data, {
      headers: httpHeaders,
    });
  }
  public getAllUsers() {
  ...
  public update(id: Number, data: any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.put(`${API_URL_USER}/${id}`, data, {
      headers: httpHeaders,
    });
  }
  public updated(id: Number, data: any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.put(`${API_URL_USER}/up${id}`, data, {
      headers: httpHeaders,
    });
  }
  public getBy(data: any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.post(`${API_URL_USER}/find`, data, {
      headers: httpHeaders,
    });
  }
  public getByOne(data: any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.post(`${API_URL_USER}/findone`, data, {
      headers: httpHeaders,
    });
  }
}
